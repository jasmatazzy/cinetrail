...
function MovieDetails() {
    ...
    console.log("image base", imgBase);
...
//https://api.themoviedb.org/3/movie/724495/reviews?api_key=c315ba96d8b132c0836df2e55986edc6
  ...
  return (
    ...
    
    {
      ...
      <p className="more-reviews" onClick={()=>setReviewNumber(reviewNumber + 3)}>Read more reviews</p>
      :
      <p className="more-reviews" onClick={()=>setReviewNumber(3)}>End of reviews</p>
